...
export const Resume = () => {
  ...
  return (
    <section id="resume" className="max-w-4xl mx-auto py-20 px-4">
      ...
      {/* Hidden iframe to preload the PDF */}
<iframe
  src={RESUME_URL}
  style={{ display: "none" }}
  onLoad={() => setIframeLoaded(true)}
/>
      <div ref ={ref} className="bg-slate-800 rounded-xl shadow-lg mb-8 overflow-hidden">
       {inView && iframeLoaded?(
        <iframe
          src={RESUME_URL}
          title="Resume PDF"
        ...
        />
          ...
          <div className="text-white text-center py-20">Loading Resume...</div>
        )}
